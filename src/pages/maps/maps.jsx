  ...
  const handleSubmit = async (e, formType) => {
    ...
    switch (formType) {
      case "osc":
        ...
        const phoneNumberosc = `${formData.telephone_code1 || ""}${
          formData.phone1 || ""
        }`.trim();
      ...
      case "bailleurs":
        ...
        const phoneNumber = `${formDataBailleur.telephone_code || ""}${
          formDataBailleur.telephone_number || ""
        }`.trim();
      ...
      case "entreprises":
        ...
        const telephone = `${formDataEntreprise.telephone_code || ""}${
          formDataEntreprise.telephone_number || ""
        }`.trim();
