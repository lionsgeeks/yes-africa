        ...
        switch (formType) {
            case "osc":
                ...
                if (Array.isArray(formData.intervention_areas)) {
                    formData.intervention_areas.forEach((area) => {
                        formDataOsc.append("intervention_areas[]", area);
                    });
                }
                formDataOsc.append(
                    "social_facebook",
                    formData.socials.social_facebook ? 1 : 0
                );
                formDataOsc.append(
                    "social_twitter",
                    formData.socials.social_twitter ? 1 : 0
                );
                formDataOsc.append(
                    "social_linkedin",
                    formData.socials.social_linkedin ? 1 : 0
                );
                formDataOsc.append(
                    "social_instagram",
                    formData.socials.social_instagram ? 1 : 0
                );
                if (formData.socials.social_facebook)
                    formDataOsc.append("facebook_url", formData.facebook_url);
                if (formData.socials.social_twitter)
                    formDataOsc.append("twitter_url", formData.twitter_url);
                if (formData.socials.social_linkedin)
                    formDataOsc.append("linkedin_url", formData.linkedin_url);
                if (formData.socials.social_instagram)
                    formDataOsc.append("instagram_url", formData.instagram_url);
                formDataOsc.append("website", formData.website);
                formDataOsc.append("main_email", formData.main_email);

                const phoneNumberosc = `${formData.telephone_code1 || ""}${formData.phone1 || ""
                    }`.trim();
            ...
            case "bailleurs":
                ...
                formDataToSend.append(
                    "type_institution",
                    formDataBailleur.type_institution
                );
                ...
                const phoneNumber = `${formDataBailleur.telephone_code || ""}${formDataBailleur.telephone_number || ""
                    }`.trim();
                formDataToSend.append("telephone", phoneNumber);

                formDataToSend.append(
                    "priorites_thematiques",
                    formDataBailleur.priorites_thematiques
                );
                ...
                if (Array.isArray(formDataBailleur.couverture_geographique)) {
                    formDataBailleur.couverture_geographique.forEach((r) =>
                        formDataToSend.append("couverture_geographique[]", r)
                    );
                }
                ...
                formDataToSend.append(
                    "linkedin_url2",
                    formDataBailleur.linkedin_url2 || ""
                );
                formDataToSend.append(
                    "twitter_url2",
                    formDataBailleur.twitter_url2 || ""
                );
                formDataToSend.append(
                    "contact_responsable[nom]",
                    formDataBailleur.contact_responsable.nom
                );
                formDataToSend.append(
                    "contact_responsable[fonction]",
                    formDataBailleur.contact_responsable.fonction
                );
                formDataToSend.append(
                    "contact_responsable[email]",
                    formDataBailleur.contact_responsable.email
                );
            ...
            case "entreprises":
                ...
                const telephone = `${formDataEntreprise.telephone_code || ""}${formDataEntreprise.telephone_number || ""
                    }`.trim();
                ...
                formData2.append(
                    "regions_recrutement",
                    formDataEntreprise.regions_recrutement
                );
                formData2.append(
                    "competences_pro_bono",
                    formDataEntreprise.competences_pro_bono
                );
                ...
                formData2.append(
                    "twitter",
                    formDataEntreprise.reseaux_sociaux2.twitter ? 1 : 0
                );
                formData2.append(
                    "linkedin",
                    formDataEntreprise.reseaux_sociaux2.linkedin ? 1 : 0
                );
                formData2.append("twitter_url", formDataEntreprise.twitter_url);
                formData2.append("linkedin_url", formDataEntreprise.linkedin_url);
                formData2.append(
                    "contact_rse[nom]",
                    formDataEntreprise.contact_rse.nom
                );
                formData2.append(
                    "contact_rse[fonction]",
                    formDataEntreprise.contact_rse.fonction
                );
                formData2.append(
                    "contact_rse[email]",
                    formDataEntreprise.contact_rse.email
                );
                formData2.append(
                    "politique_inclusion",
                    formDataEntreprise.politique_inclusion
                );
                formData2.append(
                    "programmes_integration",
                    formDataEntreprise.programmes_integration
                );
                formData2.append(
                    "postes_stages_annuels",
                    formDataEntreprise.postes_stages_annuels
                );
                formData2.append(
                    "dispositifs_formation",
                    formDataEntreprise.dispositifs_formation
                );
                formData2.append(
                    "partenariats_osc",
                    formDataEntreprise.partenariats_osc
                );
                formData2.append(
                    "initiatives_mecenat",
                    formDataEntreprise.initiatives_mecenat
                );
                formData2.append(
                    "profils_recherches",
                    formDataEntreprise.profils_recherches
                );
                formData2.append(
                    "processus_integration",
                    formDataEntreprise.processus_integration
                );
            ...
            case "agences":
                ...
                formData3.append(
                    "couverture_afrique",
                    formDataAgence.couverture_afrique
                );
                formData3.append("type_partenaires", formDataAgence.type_partenaires);
                formData3.append(
                    "outils_methodologiques",
                    formDataAgence.outils_methodologiques
                );
                if (formDataAgence.site_web)
                    formData3.append("site_web", formDataAgence.site_web);
                if (formDataAgence.bureaux_afrique)
                    formData3.append("bureaux_afrique", formDataAgence.bureaux_afrique);
                if (formDataAgence.priorites_thematiques)
                    formData3.append(
                        "priorites_thematiques",
                        formDataAgence.priorites_thematiques
                    );
                if (formDataAgence.budget)
                    formData3.append("budget", formDataAgence.budget);
                if (formDataAgence.annee_debut)
                    formData3.append("annee_debut", formDataAgence.annee_debut);
                if (formDataAgence.annee_fin)
                    formData3.append("annee_fin", formDataAgence.annee_fin);
                if (formDataAgence.opportunites_financement)
                    formData3.append(
                        "opportunites_financement",
                        formDataAgence.opportunites_financement
                    );
                if (formDataAgence.mecanismes_collaboration)
                    formData3.append(
                        "mecanismes_collaboration",
                        formDataAgence.mecanismes_collaboration
                    );
                if (formDataAgence.domaines_expertise)
                    formData3.append(
                        "domaines_expertise",
                        formDataAgence.domaines_expertise
                    );
                if (formDataAgence.logo) formData3.append("logo", formDataAgence.logo);
                if (formDataAgence.cadre_strategique)
                    formData3.append(
                        "cadre_strategique",
                        formDataAgence.cadre_strategique
                    );
                formData3.append(
                    "contact_jeunesse[nom]",
                    formDataAgence.contact_jeunesse?.nom || ""
                );
                formData3.append(
                    "contact_jeunesse[fonction]",
                    formDataAgence.contact_jeunesse?.fonction || ""
                );
                formData3.append(
                    "contact_jeunesse[email]",
                    formDataAgence.contact_jeunesse?.email || ""
                );
                formDataAgence.programmes_phares.forEach((program, index) => {
                    formData3.append(
                        `programmes_phares[${index}][titre]`,
                        program.titre || ""
                    );
                    formData3.append(
                        `programmes_phares[${index}][objectifs]`,
                        program.objectifs || ""
                    );
                    formData3.append(
                        `programmes_phares[${index}][pays_intervention]`,
                        program.pays_intervention || ""
                    );
                    formData3.append(
                        `programmes_phares[${index}][partenaires]`,
                        program.partenaires || ""
                    );
                    formData3.append(
                        `programmes_phares[${index}][resultats]`,
                        program.resultats || ""
                    );
                    formData3.append(
                        `programmes_phares[${index}][publication]`,
            ...
            case "publiques":
                ...
                formDataPubliqueForm.append(
                    "institution_name",
                    formDataPublique.institution_name
                );
                formDataPubliqueForm.append(
                    "institution_type",
                    formDataPublique.institution_type
                );
                ...
                formDataPubliqueForm.append(
                    "phone_number",
                    formDataPublique.phone_number
                );
                formDataPubliqueForm.append("address", formDataPublique.address || "");
                formDataPubliqueForm.append(
                    "youth_contact_name",
                    formDataPublique.youthContact.name
                );
                formDataPubliqueForm.append(
                    "youth_contact_position",
                    formDataPublique.youthContact.position
                );
                formDataPubliqueForm.append(
                    "youth_contact_email",
                    formDataPublique.youthContact.email
                );
                ...
                formDataPubliqueForm.append(
                    "policy_framework",
                    formDataPublique.policyFramework
                );
                formDataPubliqueForm.append(
                    "strategic_priorities",
                    formDataPublique.strategicPriorities
                );
                formDataPubliqueForm.append(
                    "annual_budget",
                    formDataPublique.annualBudget
                );
                formDataPubliqueForm.append(
                    "flagship_program",
                    formDataPublique.flagshipProgram
                );
                formDataPubliqueForm.append(
                    "target_audience",
                    formDataPublique.targetAudience
                );
                formDataPubliqueForm.append(
                    "flagship_program",
                    formDataPublique.supportMechanisms
                );
                formDataPubliqueForm.append(
                    "expected_result_1",
                    formDataPublique.expectedResults[0]
                );
                formDataPubliqueForm.append(
                    "expected_result_2",
                    formDataPublique.expectedResults[1]
                );
                formDataPubliqueForm.append(
                    "expected_result_3",
                    formDataPublique.expectedResults[2]
                );
                formDataPubliqueForm.append(
                    "execution_partners",
                    formDataPublique.executionPartners
                );
                formDataPubliqueForm.append(
                    "coordination_mechanism",
                    formDataPublique.coordinationMechanism
                );
                formDataPubliqueForm.append(
                    "involved_actors",
                    formDataPublique.involvedActors
                );
                formDataPubliqueForm.append(
                    "monitoring_approach",
                    formDataPublique.monitoringApproach
                );
                formDataPubliqueForm.append(
                    "technical_assistance",
                    formDataPublique.technicalAssistance
                );
                formDataPubliqueForm.append(
                    "best_practices",
                    formDataPublique.bestPractices
                );
                formDataPubliqueForm.append(
                    "cooperation_opportunities",
                    formDataPublique.cooperationOpportunities
                );

                try {
                    const response = await axios.post(
                        url + "/api/publique",
                        formDataPubliqueForm,
                        {
                            headers: {
                                "Content-Type": "multipart/form-data",
                            },
            ...
            case "academiques":
                ...
                formDataAcademiqueForm.append(
                    "type_institution",
                    formDataAcademique.type_institution
                );
                formDataAcademiqueForm.append("pays", formDataAcademique.pays);
                formDataAcademiqueForm.append(
                    "site_web",
                    formDataAcademique.site_web || ""
                );
                formDataAcademiqueForm.append(
                    "departement",
                    formDataAcademique.departement || ""
                );
                formDataAcademiqueForm.append("email", formDataAcademique.email);
                formDataAcademiqueForm.append(
                    "telephone",
                    `${formDataAcademique.telephone_code}${formDataAcademique.telephone_number}`
                );
                formDataAcademiqueForm.append(
                    "contact_nom",
                    formDataAcademique.contact_chercheur.nom || ""
                );
                formDataAcademiqueForm.append(
                    "contact_fonction",
                    formDataAcademique.contact_chercheur.fonction || ""
                );
                formDataAcademiqueForm.append(
                    "contact_email",
                    formDataAcademique.contact_chercheur.email || ""
                );
                formDataAcademiqueForm.append(
                    "axes_recherche",
                    formDataAcademique.axes_recherche || ""
                );
                formDataAcademiqueForm.append(
                    "methodologies",
                    formDataAcademique.methodologies || ""
                );
                ...
                formDataAcademiqueForm.append(
                    "programmes_formation",
                    formDataAcademique.programmes_formation || ""
                );
                ...
                formDataAcademiqueForm.append(
                    "certifications",
                    formDataAcademique.certifications || ""
                );
                formDataAcademiqueForm.append(
                    "partenaires_recherche",
                    formDataAcademique.partenaires_recherche || ""
                );
                ...
                formDataAcademiqueForm.append(
                    "expertise",
                    formDataAcademique.expertise || ""
                );
                formDataAcademiqueForm.append(
                    "opportunites_collaboration",
                    formDataAcademique.opportunites_collaboration || ""
                );
                formDataAcademiqueForm.append(
                    "conferences",
                    formDataAcademique.conferences || ""
                );
                formDataAcademiqueForm.append(
                    "ateliers",
                    formDataAcademique.ateliers || ""
                );
                try {
                    const response = await axios.post(
                        url + "/api/academiques",
                        formDataAcademiqueForm,
                        {
                            headers: {
                                "Content-Type": "multipart/form-data",
                            },
                    ...
                    return (
                        <div className="flex items-center bg-white/90 shadow-md rounded-xl p-4 gap-4 w-[40vw] mx-auto relative">
                            ...
                            <div className="flex flex-col w-96 justify-between gap-1 text-sm text-gray-800">
                                <p className="font-bold text-lg text-beta">
                                    {details.showable.name}
                                </p>
                                <p>
                                    <span className="font-medium text-gray-500">
                                        Statut légal:
                                    </span>{" "}
                                    {details.showable.legal_status}
                                </p>
                                ...
                                <p className="truncate">
                                    ...
                                    {details.showable.regions}
                                </p>
                                <p>
                                    <span className="font-medium text-gray-500">
                                        Groupes Cibles :
                                    </span>{" "}
                                    {details.showable.target_groups}
                                </p>
                                <p className="truncate">
                                    <span className="font-medium text-gray-500">
                                        Bonnes Pratiques :
                                    </span>{" "}
                                    {details.showable.program_title}
                                </p>
                    ...
                    return (
                        <div className="flex items-center bg-white/90 shadow-md rounded-xl p-4 gap-4 w-[40vw] mx-auto relative">
                            ...
                            <div className="flex flex-col w-full gap-2 text-sm text-gray-800">
                                <p className="font-bold text-lg text-beta">
                                    {details.showable.nom}
                                </p>
                                <p>
                                    <span className="font-medium text-gray-500">Email:</span>{" "}
                                    {details.showable.email_contact}
                                </p>
                                <p>
                                    <span className="font-medium text-gray-500">Type:</span>{" "}
                                    {details.showable.type_institution}
                                </p>
                                <p>
                                    <span className="font-medium text-gray-500">Pays:</span>{" "}
                                    {details.showable.pays_origine}
                                </p>
                                ...
                                <p>
                                    ...
                                    <a
                                        href={details.showable.site_web}
                                        className="text-blue-600 hover:underline"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
                                        {details.showable.website}
                                    </a>
                                </p>
                                <p className="truncate w-80">
                                    <span className="font-medium text-gray-500">
                                    ...
                                    {details.showable.priorites_thematiques}
                                </p>
                                <button
                                    onClick={handleSeeMore}
                                    className="mt-4 px-4 py-2 bg-beta text-white rounded hover:bg-[#a68513] w-fit"
                        ...
                        <div className="flex items-center bg-white/90 shadow-md rounded-xl p-4 gap-4 w-[40vw] mx-auto relative">
                            ...
                            <div className="flex flex-col w-full gap-2 text-sm text-gray-800">
                                ...
                                <p>
                                    ...
                                    {details.showable.secteur}
                                </p>
                                <p>
                                    <span className="font-medium text-gray-500">
                                        Taille de l'entreprise:
                                    </span>{" "}
                                    {details.showable.taille}
                                </p>
                                <p>
                                    <span className="font-medium text-gray-500">Site web:</span>{" "}
                                    <a
                                ...
                                <p>
                                    <span className="font-medium text-gray-500">Pays:</span>{" "}
                                    {details.showable.pays_siege}
                                </p>
                                <p>
                                    <span className="font-medium text-gray-500">LinkedIn:</span>{" "}
                                    <a
                                        href={details.showable.linkedin_url}
                                        className="text-blue-600 hover:underline"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
                                        {details.showable.linkedin_url}
                                    </a>
                                </p>
                                <p>
                                    <span className="font-medium text-gray-500">Twitter:</span>{" "}
                                    <a
                                        href={details.showable.twitter_url}
                                        className="text-blue-600 hover:underline"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
                                        {details.showable.twitter_url}
                                    </a>
                                </p>
                                <button
                                    onClick={handleSeeMore}
                    ...
                    return (
                        <div className="flex items-center bg-white/90 shadow-md rounded-xl p-4 gap-4 w-[40vw] mx-auto relative">
                            ...
                            <div className="flex flex-col w-full gap-2 text-sm text-gray-800">
                                ...
                                <p>
                                    <span className="font-medium text-gray-500">Email:</span>{" "}
                                    {details.showable.email_institutionnel}
                                </p>
                                <p>
                                    <span className="font-medium text-gray-500">Type:</span>{" "}
                                    {details.showable.type_organisation}
                                </p>
                                <p>
                                    <span className="font-medium text-gray-500">Site web:</span>{" "}
                                    <a
                                ...
                                <p>
                                    <span className="font-medium text-gray-500">Pays:</span>{" "}
                                    {details.showable.pays_representes}
                                </p>
                                <p>
                                    <span className="font-medium text-gray-500">
                                        Couverture afrique:
                                    ...
                                    <a
                                        href={details.showable.couverture_afrique}
                                        className="text-blue-600 hover:underline"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
                ...
                case "App\\Models\\Publique":
                    return (
                        <div className="flex items-center bg-white/90 shadow-md rounded-xl p-4 gap-4 w-[40vw] mx-auto relative">
                            ...
                            <div className="flex flex-col w-full gap-2 text-sm text-gray-800">
                                <p className="font-bold text-lg text-beta">
                                    {details.showable.institution_name}
                                </p>
                                <p>
                                    <span className="font-medium text-gray-500">Email:</span>{" "}
                                    {details.showable.email}
                                </p>
                                <p>
                                    <span className="font-medium text-gray-500">Type:</span>{" "}
                                    {details.showable.institution_type}
                                </p>
                                <p>
                                    <span className="font-medium text-gray-500">Pays:</span>{" "}
                                    {details.showable.country}
                                </p>
                                <p>
                                    <span className="font-medium text-gray-500">Site web:</span>{" "}
                                    <a
                                        href={details.showable.website}
                                        className="text-blue-600 hover:underline"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
                    ...
                    return (
                        <div className="flex items-center bg-white/90 shadow-md rounded-xl p-4 gap-4 w-[40vw] mx-auto relative">
                            ...
                            <div className="flex flex-col w-full gap-2 text-sm text-gray-800">
                                ...
                                <p>
                                    <span className="font-medium text-gray-500">Pays:</span>{" "}
                                    {details.showable.pays}
                                </p>
                                <p>
                                    <span className="font-medium text-gray-500">
                                        Departement concerné:
                                    </span>{" "}
                                    <a
                                        href={details.showable.departement}
                                        className="text-blue-600 hover:underline"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
        ...
        <>
                                    ...
                                    >
                                        <div className="w-10 aspect-square object-cover bg-gray-100 rounded-full ">
                                            <img
                                                src={
                                                    url +
                                                    `/storage/${element.showable.logo || element.showable.logo_path
                                                    }`
                                                }
            ...
            <div className="fixed bottom-4 right-4 gap-3 flex flex-col items-end">
                <button
                    ...
                    className="p-2 aspect-square animate-bounce bg-alpha text-white rounded-full "
                >
                        ...
                        {step === 2 && (
                            <>
                                ...
                                <p className="mb-3 text-sm text-gray-700">
                                    ...
                                    <strong className="text-beta">{form.email}</strong>
                                </p>
                            ...
                            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                                <div className="bg-white p-6 rounded shadow-lg w-[80%] overflow-y-scroll ">
                                        ...
                                        {
                                            {
                                                ...
                                                agences:
                                                    "Formulaire - Agence des Nations Unies et Coopération",
                                                publiques: "Formulaire - Institution Publique",
                                                academiques:
                                                    "Formulaire - Institution Académique et de Recherche",
                                            }[selectedForm]
                                        }
                                    </h2>
                                    ...
                                    {selectedForm === "osc" && (
                                        <>
                                            <form
                                                className="w-[75vw]  bg-white rounded-lg shadow-md h-[78vh]"
                                                onSubmit={(e) => handleSubmit(e, "osc")}
                                            >
                                                <fieldset className="bg-gray-100 p-6 rounded-lg">
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                            ...
                                                            {formData.legal_status === "Autre" && (
                                                                <input
                                                                    ...
                                                                    onChange={(e) =>
                                                                        setFormData({
                                                                            ...formData,
                                                                            other_legal_status: e.target.value,
                                                                        })
                                                                    }
                                                                />
                                                            )}{" "}
                                                            ...
                                                            <div className="flex flex-col">
                                                                {data.map((item) => (
                                                                    ...
                                                                    >
                                                                        <input
                                                                            type="checkbox"
                                                                            checked={formData.regions.includes(
                                                                                item.name
                                                                            )}
                                                                            value={item.name}
                                                                            onChange={(e) => {
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            {formData.socials &&
                                                                formData.socials.social_facebook && (
                                                                    <input
                                                                        type="url"
                                                            ...
                                                            {formData.socials &&
                                                                formData.socials.social_twitter && (
                                                                    <input
                                                                        type="url"
                                                            ...
                                                            {formData.socials &&
                                                                formData.socials.social_linkedin && (
                                                                    <input
                                                                        type="url"
                                                ...
                                                <fieldset className="bg-gray-100 p-6 rounded-lg">
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-1 gap-2">
                                                        ...
                                                        <div className="space-y-2">
                                                            <label className="block text-sm font-medium text-gray-700">
                                                                Nombre de bénéficiaires annuels (NEET)
                                                            </label>
                                                            <input
                                                                type="number"
                                                                min="0"
                                                                className="w-full p-2 border rounded-md"
                                                                name="annual_beneficiaries"
                                                                value={formData.annual_beneficiaries}
                                                                onChange={(e) =>
                                                                    setFormData({
                                                                        ...formData,
                                                                        annual_beneficiaries: e.target.value,
                                                                    })
                                                                }
                                                            />
                                                        </div>
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                        <div className="space-y-2">
                                                            ...
                                                            <textarea
                                                                className="w-full p-2 border rounded-md"
                                                                rows="3"
                                                                name="technical_partners"
                                                                value={formData.technical_partners}
                                                                onChange={(e) =>
                                                                    setFormData({
                                                                        ...formData,
                                                                        technical_partners: e.target.value,
                                                                    })
                                                                }
                                                            ></textarea>
                                                        </div>
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <textarea
                                                                ...
                                                                value={formData.financial_partners}
                                                                onChange={(e) =>
                                                                    setFormData({
                                                                        ...formData,
                                                                        financial_partners: e.target.value,
                                                                    })
                                                                }
                                                            ></textarea>
                                                        </div>
                                    ...
                                    {selectedForm === "bailleurs" && (
                                        <>
                                            <form
                                                className="w-[75vw] bg-white rounded-lg shadow-md h-[78vh]"
                                                onSubmit={(e) => handleSubmit(e, "bailleurs")}
                                            >
                                                <fieldset className="bg-gray-100 p-6 rounded-lg">
                                                    <legend className="text-xl font-bold text-alpha mb-4">
                                                        Informations Générales
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <select
                                                                ...
                                                                onChange={(e) =>
                                                                    setFormDataBailleur({
                                                                        ...formDataBailleur,
                                                                        type_institution: e.target.value,
                                                                    })
                                                                }
                                                            >
                                                                <option value="">Sélectionner...</option>
                                                            ...
                                                            {formDataBailleur.type_institution ===
                                                                "Autre" && (
                                                                    <input
                                                                        ...
                                                                        value={
                                                                            formDataBailleur.type_institution_autre
                                                                        }
                                                                        onChange={(e) =>
                                                                            setFormDataBailleur({
                                                                                ...formDataBailleur,
                                                                                type_institution_autre: e.target.value,
                                                                            })
                                                                        }
                                                                    />
                                                                )}
                                                            ...
                                                            <div className="flex flex-col">
                                                                {data.map((item) => (
                                                                    ...
                                                                    >
                                                                        <input
                                                                            type="checkbox"
                                                                            checked={formDataBailleur.couverture_geographique.includes(
                                                                                item.name
                                                                            )}
                                                                            value={item.name}
                                                                            onChange={(e) => {
                                                                                const { checked, value } = e.target;
                                                                                setFormDataBailleur((prev) => {
                                                                                    let updatedcouverture_geographique =
                                                                                        checked
                                                                                            ? [
                                                                                                ...prev.couverture_geographique,
                                                                                                value,
                                                                                            ]
                                                                                            : prev.couverture_geographique.filter(
                                                                                                (r) => r !== value
                                                                                            );
                                                                                    return {
                                                                                        ...prev,
                                                                                        couverture_geographique:
                                                                                            updatedcouverture_geographique,
                                                                                    };
                                                                                });
                                                                            }}
                                                                        />
                                                        ...
                                                        <div className="space-y-2 md:col-span-2">
                                                            ...
                                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                                                                ...
                                                                <input
                                                                    ...
                                                                    value={
                                                                        formDataBailleur.contact_responsable
                                                                            ?.fonction || ""
                                                                    }
                                                                    onChange={(e) =>
                                                                        setFormDataBailleur((prev) => ({
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <textarea
                                                                ...
                                                                onChange={(e) =>
                                                                    setFormDataBailleur({
                                                                        ...formDataBailleur,
                                                                        priorites_thematiques: e.target.value,
                                                                    })
                                                                }
                                                            ></textarea>
                                                        </div>
                                                        ...
                                                        <div className="flex flex-col">
                                                            {data.map((item) => (
                                                                ...
                                                                >
                                                                    <input
                                                                        type="checkbox"
                                                                        checked={formDataEntreprise.regions_afrique.includes(
                                                                            item.name
                                                                        )}
                                                                        value={item.name}
                                                                        onChange={(e) => {
                                                                            ...
                                                                            setFormDataEntreprise((prev) => {
                                                                                let updatedregions_afrique = checked
                                                                                    ...
                                                                                    : prev.regions_afrique.filter(
                                                                                        (r) => r !== value
                                                                                    );
                                                                                return {
                                                                                    ...prev,
                                                                                    regions_afrique:
                                                                                        updatedregions_afrique,
                                                                                };
                                                                            });
                                                                        }}
                                                                    />
                                                    ...
                                                    <div className="space-y-2">
                                                        ...
                                                        <textarea
                                                            ...
                                                            onChange={(e) =>
                                                                setFormDataEntreprise((prev) => ({
                                                                    ...prev,
                                                                    politique_inclusion: e.target.value,
                                                                }))
                                                            }
                                                            className="w-full p-3 border rounded-lg"
                                                        />
                                                    ...
                                                    <div className="space-y-2">
                                                        ...
                                                        <textarea
                                                            ...
                                                            onChange={(e) =>
                                                                setFormDataEntreprise((prev) => ({
                                                                    ...prev,
                                                                    programmes_integration: e.target.value,
                                                                }))
                                                            }
                                                            className="w-full p-3 border rounded-lg"
                                                        />
                                                    ...
                                                    <div className="space-y-2">
                                                        ...
                                                        <textarea
                                                            ...
                                                            onChange={(e) =>
                                                                setFormDataEntreprise((prev) => ({
                                                                    ...prev,
                                                                    dispositifs_formation: e.target.value,
                                                                }))
                                                            }
                                                            className="w-full p-3 border rounded-lg"
                                                        />
                                                    ...
                                                    <div className="space-y-2">
                                                        ...
                                                        <textarea
                                                            ...
                                                            onChange={(e) =>
                                                                setFormDataEntreprise((prev) => ({
                                                                    ...prev,
                                                                    partenariats_osc: e.target.value,
                                                                }))
                                                            }
                                                            className="w-full p-3 border rounded-lg"
                                                    ...
                                                    <div className="space-y-2">
                                                        ...
                                                        <textarea
                                                            ...
                                                            onChange={(e) =>
                                                                setFormDataEntreprise((prev) => ({
                                                                    ...prev,
                                                                    initiatives_mecenat: e.target.value,
                                                                }))
                                                            }
                                                            className="w-full p-3 border rounded-lg"
                                                        />
                                                    ...
                                                    <div className="space-y-2">
                                                        ...
                                                        <textarea
                                                            ...
                                                            onChange={(e) =>
                                                                setFormDataEntreprise((prev) => ({
                                                                    ...prev,
                                                                    profils_recherches: e.target.value,
                                                                }))
                                                            }
                                                            className="w-full p-3 border rounded-lg"
                                                        />
                                                    ...
                                                    <div className="space-y-2">
                                                        ...
                                                        <textarea
                                                            ...
                                                            onChange={(e) =>
                                                                setFormDataEntreprise((prev) => ({
                                                                    ...prev,
                                                                    processus_integration: e.target.value,
                                                                }))
                                                            }
                                                            className="w-full p-3 border rounded-lg"
                                                        />
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <select
                                                                ...
                                                                onChange={(e) =>
                                                                    setFormDataAgence((prev) => ({
                                                                        ...prev,
                                                                        type_organisation: e.target.value,
                                                                    }))
                                                                }
                                                            >
                                                                <option value="">Sélectionner...</option>
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <select
                                                                ...
                                                                onChange={(e) =>
                                                                    setFormDataAgence((prev) => ({
                                                                        ...prev,
                                                                        pays_representes: e.target.value,
                                                                    }))
                                                                }
                                                            >
                                                                {data.map((item) => (
                                                        ...
                                                        <div className="space-y-2 md:col-span-2">
                                                            ...
                                                            <select
                                                                ...
                                                                onChange={(e) =>
                                                                    setFormDataAgence((prev) => ({
                                                                        ...prev,
                                                                        couverture_afrique: e.target.value,
                                                                    }))
                                                                }
                                                            >
                                                                {data.map((item) => (
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <input
                                                                ...
                                                                onChange={(e) =>
                                                                    setFormDataAgence((prev) => ({
                                                                        ...prev,
                                                                        email_institutionnel: e.target.value,
                                                                    }))
                                                                }
                                                            />
                                                        </div>
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <textarea
                                                                ...
                                                                onChange={(e) =>
                                                                    setFormDataAgence((prev) => ({
                                                                        ...prev,
                                                                        bureaux_afrique: e.target.value,
                                                                    }))
                                                                }
                                                            ></textarea>
                                                        </div>
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <input
                                                                ...
                                                                onChange={(e) =>
                                                                    setFormDataAgence((prev) => ({
                                                                        ...prev,
                                                                        cadre_strategique: e.target.files[0],
                                                                    }))
                                                                }
                                                            />
                                                        </div>
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <input
                                                                ...
                                                                onChange={(e) =>
                                                                    setFormDataAgence((prev) => ({
                                                                        ...prev,
                                                                        outils_methodologiques: e.target.files[0],
                                                                    }))
                                                                }
                                                            />
                                                        </div>
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <textarea
                                                                ...
                                                                onChange={(e) =>
                                                                    setFormDataAgence((prev) => ({
                                                                        ...prev,
                                                                        opportunites_financement: e.target.value,
                                                                    }))
                                                                }
                                                            ></textarea>
                                                        </div>
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <select
                                                                ...
                                                                onChange={(e) =>
                                                                    setFormDataAgence((prev) => ({
                                                                        ...prev,
                                                                        type_partenaires: e.target.value,
                                                                    }))
                                                                }
                                                            >
                                                                <option value="ONG">ONG</option>
                                                                <option value="Entreprises privées">
                                                                    Entreprises privées
                                                                </option>
                                                                <option value="Institutions gouvernementales">
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <input
                                                                ...
                                                                onChange={(e) =>
                                                                    setFormDataAgence((prev) => ({
                                                                        ...prev,
                                                                        mecanismes_collaboration: e.target.value,
                                                                    }))
                                                                }
                                                            />
                                                        </div>
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <textarea
                                                                ...
                                                                onChange={(e) =>
                                                                    setFormDataAgence((prev) => ({
                                                                        ...prev,
                                                                        domaines_expertise: e.target.value,
                                                                    }))
                                                                }
                                                            ></textarea>
                                                        </div>
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            >
                                                                ...
                                                                <option value="Agence gouvernementale">
                                                                ...
                                                                <input
                                                                    ...
                                                                    onChange={(e) =>
                                                                        setFormDataPublique({
                                                                            ...
                                                                            youthContact: {
                                                                                ...formDataPublique,
                                                                                youth_contact_name: e.target.value,
                                                                            },
                                                                        })
                                                                    }
                                                                    placeholder="Nom complet"
                                                                ...
                                                                <input
                                                                    ...
                                                                    onChange={(e) =>
                                                                        setFormDataPublique({
                                                                            ...
                                                                            youthContact: {
                                                                                ...formDataPublique,
                                                                                youth_contact_position: e.target.value,
                                                                            },
                                                                        })
                                                                    }
                                                                    placeholder="Fonction"
                                                                ...
                                                                <input
                                                                    ...
                                                                    onChange={(e) =>
                                                                        setFormDataPublique({
                                                                            ...
                                                                            youthContact: {
                                                                                ...formDataPublique,
                                                                                youth_contact_email: e.target.value,
                                                                            },
                                                                        })
                                                                    }
                                                                    placeholder="Email professionnel"
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <textarea
                                                                ...
                                                                onChange={(e) =>
                                                                    setFormDataPublique({
                                                                        ...formDataPublique,
                                                                        strategicPriorities: e.target.value,
                                                                    })
                                                                }
                                                                className="w-full p-3 border rounded-lg"
                                                                rows="3"
                                                    ...
                                                    <div className="grid grid-cols-1 gap-6">
                                                        <div className="space-y-2">
                                                            ...
                                                            <input
                                                                ...
                                                                onChange={(e) =>
                                                                    setFormDataPublique({
                                                                        ...formDataPublique,
                                                                        flagshipProgram: e.target.value,
                                                                    })
                                                                }
                                                                className="w-full p-3 border rounded-lg"
                                                            />
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <textarea
                                                                ...
                                                                onChange={(e) =>
                                                                    setFormDataPublique({
                                                                        ...formDataPublique,
                                                                        supportMechanisms: e.target.value,
                                                                    })
                                                                }
                                                                className="w-full p-3 border rounded-lg"
                                                                rows="3"
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                                {formDataPublique.expectedResults.map(
                                                                    (result, index) => (
                                                                        <input
                                                                            key={index}
                                                                            type="text"
                                                                            ...
                                                                            onChange={(e) => {
                                                                                const newResults = [
                                                                                    ...formDataPublique.expectedResults,
                                                                                ];
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <textarea
                                                                ...
                                                                onChange={(e) =>
                                                                    setFormDataPublique({
                                                                        ...formDataPublique,
                                                                        executionPartners: e.target.value,
                                                                    })
                                                                }
                                                                className="w-full p-3 border rounded-lg"
                                                                rows="3"
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <input
                                                                ...
                                                                onChange={(e) =>
                                                                    setFormDataPublique({
                                                                        ...formDataPublique,
                                                                        coordinationMechanism: e.target.value,
                                                                    })
                                                                }
                                                                className="w-full p-3 border rounded-lg"
                                                            />
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <textarea
                                                                ...
                                                                onChange={(e) =>
                                                                    setFormDataPublique({
                                                                        ...formDataPublique,
                                                                        monitoringApproach: e.target.value,
                                                                    })
                                                                }
                                                                className="w-full p-3 border rounded-lg"
                                                                rows="3"
                                                        ...
                                                        <div className="space-y-2 md:col-span-2">
                                                            ...
                                                            <textarea
                                                                ...
                                                                onChange={(e) =>
                                                                    setFormDataPublique({
                                                                        ...formDataPublique,
                                                                        cooperationOpportunities: e.target.value,
                                                                    })
                                                                }
                                                                className="w-full p-3 border rounded-lg"
                                                                rows="4"
                                                        ...
                                                        <div className="space-y-2 md:col-span-2">
                                                            ...
                                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                                ...
                                                                <input
                                                                    ...
                                                                    placeholder="Fonction"
                                                                    value={
                                                                        formDataAcademique.contact_chercheur
                                                                            .fonction
                                                                    }
                                                                    onChange={handleContactChercheurChange}
                                                                    className="p-3 border rounded-lg"
                                                    ...
                                                    <div className="flex flex-col gap-5">
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <div className="grid grid-cols-3 gap-2">
                                                                {["Étudiants", "Professionnels", "OSC"].map(
                                                                    (option) => (
                                                                        <label
                                                                            key={option}
                                                                            className="flex items-center"
                                                                        >
                                                                            <input
                                                                                type="checkbox"
                                                                                checked={formDataAcademique.public_cible.includes(
                                                                                    option
                                                                                )}
                                                                                onChange={() =>
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <div className="grid grid-cols-3 gap-2">
                                                                {["Présentiel", "En ligne", "Hybride"].map(
                                                                    (option) => (
                                                                        <label
                                                                            key={option}
                                                                            className="flex items-center"
                                                                        >
                                                                            <input
                                                                                type="checkbox"
                                                                                checked={formDataAcademique.modalites.includes(
                                                                                    option
                                                                                )}
                                                                                onChange={() =>
                                                                                    handleCheckboxChange(
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <select
                                                                ...
                                                                value={
                                                                    formDataAcademique.ressources_disponibles
                                                                }
                                                                onChange={(e) => {
                                                                    const selected = Array.from(
                                                                        e.target.selectedOptions,
                                                                    ...
                                                                    setFormDataAcademique((prev) => ({
                                                                        ...prev,
                                                                        ressources_disponibles: selected,
                                                                    }));
                                                                }}
                                                                className="w-full p-3 border rounded-lg h-32"
                                                            >
                                                                ...
                                                                <option value="Outils d'analyse">
                                                                    Outils d'analyse
                                                                </option>
                                                                <option value="Méthodologies">
                                                                    Méthodologies
                                                                </option>
