        ...
        <div>
          {
            organizers.map((org, ind) => (
              <div key={ind} className={`my-8 flex justify-between items-start gap-6 flex-col ${ind % 2 == 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'}`}>
                <div className="flex items-center justify-center w-full bg-white lg:w-[40%] sticky top-[75px]">
                  <img src={org.logo} alt="" className={` bg-white ${org.logo == ucgc ? 'w-[210px]' : 'w-[120px] lg:w-[180px]'}`} />
                </div>
