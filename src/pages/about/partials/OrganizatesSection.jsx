      ...
      >
        ...
        <div>
          {organizers.map((org, ind) => (
            <div
              key={ind}
              className={` px-6 md:px-10 lg:px-14 py-14 md:py-10 my-8 flex justify-between items-start gap-6 flex-col ${
                ind % 2 == 1
            ...
            >
              <div
                className={`flex items-center justify-center  md:bg-transparent w-full lg:w-[40%] sticky top-[75px] ${
                  ind % 2 == 1 ? "bg-muted-background" : "bg-white"
                }`}
              >
                <img
                  src={org.logo}
