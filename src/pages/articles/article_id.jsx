    ...
    <div className="flex lg:flex-row flex-col justify-center p-10">
      <div className="lg:w-[70%]">
        ...
        <div className="py-5 flex flex-col gap-5">
          ...
          <p className="text-lg">{blogs[id].description}</p>
        </div>
        <h1 className="font-bold text-xl mb-[1.5vh]">Tags</h1>
        <div className="flex gap-3">
          {tags.map((e, i) => (
            <div className="bg-gray-200 px-3 py-2 rounded-lg w-fit">{e}</div>
          ))}
        </div>
      </div>
      <div className="lg:w-[30%] lg:px-5 flex flex-col gap-3">
        <h1 className="text-xl font-semibold">Populer Posted</h1>
        {blogs.map(
          (e, index) =>
            index != id && (
              <div
