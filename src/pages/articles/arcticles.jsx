...
const ArticlesPage = () => {
  ...
  return (
    <div className="">
      <div className="w-full h-[50vh] relative -z-20 text-white lg:px-16 flex flex-col justify-center gap-3 bg-no-repeat bg-cover bg-center bg-[url('/src/assets/images/africa1.jpg')]">
        ...
        <p className="lg:text-4xl text-2xl px-3 lg:w-[70%] ">
          Dive into a world of insightful stories, expert analysis, and
          ...
          {blogs.map((blog, index) => (
            ...
            >
              ...
              <div className="p-3 gap-3 flex flex-col ">
                ...
                <div className="flex gap-3 flex-wrap font-medium text-sm ">
                  <p className="bg-gray-200 px-2 py-1 rounded-lg">#Decision_Making_Power</p>
                  <p className="bg-gray-200 px-2 py-1 rounded-lg">#Access_to_Funding</p>
                </div>
                <div
                  onClick={() => navigate(`/articles/${index}`)}
                  className="flex gap-2 items-center w-fit cursor-pointer font-bold"
                >
                  <h1>Read More</h1> {arrow}
                </div>
              </div>
            </div>
          ))}
