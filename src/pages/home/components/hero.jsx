    ...
    const slides = [
        {
            ...
            desc: { en: "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Laudantium sunt dolor voluptatem quam odit ad ea, hic harum dolore ipsa? Repudiandae ad aperiam nemo enim aliquam temporibus quo veniam ab.", ar: "لكن لا بد أن أوضح لك أن كل هذه الأفكار المغلوطة حول استنكار  النشوة وتمجيد الألم نشأت بالفعل، وسأعرض لك التفاصيل لتكتشف حقيقة وأساس تلك السعادة البشرية، فلا أحد يرفض أو يكره أو يتجنب الشعور بالسعادة، ولكن بفضل هؤلاء الأشخاص الذين لا يدركون بأن السعادة لا بد أن نستشعرها بصورة أكثر عقلانية ومنطقية فيعرضهم هذا لمواجهة الظروف الأليمة، وأكرر بأنه لا يوجد من يرغب في الحب ونيل المنال ويتلذذ بالآلام، الألم هو الألم ولكن نتيجة لظروف ما قد تكمن السعاده فيما نتحمله من كد وأسي." }
        },
        {
            img: hero2,
            title: { en: "Youth Empowerment Summit, Africa", ar: "قمة تكوين الشباب. أفريقيا" },
            ...
            >
                ...
                {slides.map(({img, title, desc}, index) => (
                    <SwiperSlide key={index}>
                        ...
                        >
                            <div className={`flex items-center w-full h-full bg-black/40 text-white 
